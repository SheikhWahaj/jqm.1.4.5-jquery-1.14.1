...
// Patch for popup
(function ($) {
    var oldPopup = $.fn.popup;
    $.fn.popup = function (method) {
        if (typeof method === "string" && !this.data("mobile-popup")) {
            return this; // skip if not initialized
        }
...
// Patch for table
(function ($) {
    var oldTable = $.fn.table;
    $.fn.table = function (method) {
        if (typeof method === "string") {
            return this.each(function () {
                if ($(this).data("mobile-table")) {
                    oldTable.apply($(this), [method]);
                }
            });
        }
        return oldTable.apply(this, arguments);
    };
})(jQuery);